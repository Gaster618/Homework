...
def test_get_data():
	...
	assert(matrix._get_data() ==[[1, 2], [3, 4]])
	assert(repr(matrix) == '1 2 \n3 4')
...
def test_flip_left_right():
	matrix = MyMatrix([[1, 2, 3], [4, 5, 6]])
	assert(matrix.flip_left_right()._get_data() == [[3, 2, 1], [6, 5, 4]])
	assert(repr(matrix) == '3 2 1 \n6 5 4')
	matrix = MyMatrix([[1, 2], [3, 4], [5, 6]])
	assert(matrix.flip_left_right()._get_data() == [[2, 1], [4, 3], [6, 5]])
...
def test_flipped_left_right():
	...
	assert(repr(matrix) == '1 2 3 \n4 5 6')
	matrix = MyMatrix([[1, 2], [3, 4], [5, 6]])
	assert(matrix.flipped_left_right()._get_data() == [[2, 1], [4, 3], [6, 5]])

def test_transpose():
	matrix = MyMatrix([[1, 2, 3], [4, 5, 6]])
	assert(matrix.transpose()._get_data() == [[1, 4], [2, 5], [3, 6]])
	assert(repr(matrix) == '1 4 \n2 5 \n3 6')
	matrix = MyMatrix([[1, 2], [3, 4], [5, 6]])
	assert(matrix.transpose()._get_data() == [[1, 3, 5], [2, 4, 6]])

def test_transposed():
	matrix = MyMatrix([[1, 2, 3], [4, 5, 6]])
	assert(matrix.transposed()._get_data() == [[1, 4], [2, 5], [3, 6]])
	assert(repr(matrix) == '1 2 3 \n4 5 6')
	matrix = MyMatrix([[1, 2], [3, 4], [5, 6]])
	assert(matrix.transposed()._get_data() == [[1, 3, 5], [2, 4, 6]])
